...
namespace List
{
    public class ArrayList
    {
        ...
        {
            AddListByIndex(index: Length, arrayList);
        }

        public void AddListFirst(int[] arrayList)
        {
            AddListByIndex(index: 0, arrayList);
        }
        ...
        public void RemoveFirst(int countElements)
        {
            ...
            MoveLeftToIndex(index: 0, countElements);
            Resize();
        }
        ...
        public int FindMax()
        {
            return _array[FindIndexMax()];
        }

        public int FindMin()
        {
            return _array[FindIndexMin()];
        }
